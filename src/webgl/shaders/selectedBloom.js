...
export default class SelectedBloom {
  constructor(){
    ...
    var obj = new THREE.Mesh(new THREE.BoxGeometry(5, 5, 4), new THREE.MeshBasicMaterial({color: 'black', wireframe: false}))
    ...
    objBack.position.z = 18.270
    // objBack.layers.disableAll()
